...
export const ResumeCenteredProfile = ({ resume, isPdf = false }: { resume: ResumeData; isPdf?: boolean }) => {
  ...
  return (
    ...
    >
      <header className="flex flex-col items-center border-b pb-8 text-center" style={{ borderColor: `${accent}33` }}>
        <ResumePhoto
        ...
        />
        <h1 className="mt-5 text-[34px] font-bold text-slate-900">{resume.personal.fullName}</h1>
